#ExternalChecksum("D:\Customer's\CXML\CVBxml\MainPage.xaml", "{406ea660-64cf-4c82-b6f0-42d48172a799}", "902EC8CC35AD9A845D38384EE8E05292")
'------------------------------------------------------------------------------
' <auto-generated>
...
Namespace Global.CVBxml
    ...
    Partial Class MainPage
        ...
        Public Sub Connect(ByVal connectionId As Integer, ByVal target As Global.System.Object) Implements Global.Windows.UI.Xaml.Markup.IComponentConnector.Connect
            ...
            Case 1
                    Me.Txtshow = CType(target, Global.Windows.UI.Xaml.Controls.TextBlock)
                    Exit Select
            Case 2
                    Me.Readxml = CType(target, Global.Windows.UI.Xaml.Controls.Button)
#ExternalSource("..\..\..\MainPage.xaml",12)
                AddHandler DirectCast(Me.Readxml, Global.Windows.UI.Xaml.Controls.Button).Click, AddressOf Me.Readxml_Click
#End ExternalSource
                    Exit Select
                    Case Else
                        Exit Select
