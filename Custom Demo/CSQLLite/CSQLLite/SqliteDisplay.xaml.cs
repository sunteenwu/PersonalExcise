...
namespace CSQLLite
{
    ...
    public sealed partial class SqliteDisplay : Page
    {
        ...
        public static string DB_Name = "kamus.sqlite";
        ...
        private async void ReadFileIndo()
        {
            ...
            SQLiteConnection _connection = new SQLiteConnection(Path.Combine(Package.Current.InstalledLocation.Path, @"Assets\kamus.sqlite"));
