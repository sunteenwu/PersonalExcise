...
namespace CListeView
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void mylistview_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            {
                ListViewItem listItem =list.SelectedItem as ListViewItem;             

            }
            
       
            
            System.Diagnostics.Debug.WriteLine(e.ClickedItem.ToString());
            //ListViewItem listItem = list.ContainerFromItem(e.ClickedItem) as ListViewItem;
           // System.Diagnostics.Debug.WriteLine(list.ContainerFromIndex(1).ToString());
          
            // System.Diagnostics.Debug.WriteLine(listItem.IsSelected.ToString());
            //if (listItem != null)
            //{
