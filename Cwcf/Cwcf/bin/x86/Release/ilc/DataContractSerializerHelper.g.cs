...
namespace System.Runtime.Serialization.Generated
{
    ...
    public static partial class DataContractSerializerHelper
    {
        ...
        static int[] s_xmlDictionaryStrings = new int[] {
                ...
                5, // array length: 5
                397, // index: 397, string: "HelpLink"
                406, // index: 406, string: "InnerException"
                421, // index: 421, string: "Message"
                429, // index: 429, string: "StackTrace"
                440, // index: 440, string: "Type"
                5, // array length: 5
                271, // index: 271, string: "http://schemas.datacontract.org/2004/07/System.ServiceModel"
                271, // index: 271, string: "http://schemas.datacontract.org/2004/07/System.ServiceModel"
                271, // index: 271, string: "http://schemas.datacontract.org/2004/07/System.ServiceModel"
                ...
                -1, // string: null
                1, // array length: 1
                345, // index: 345, string: "http://schemas.datacontract.org/2004/07/WcfService1"
                2, // array length: 2
                445, // index: 445, string: "BoolValue"
                455, // index: 455, string: "StringValue"
                2, // array length: 2
                345, // index: 345, string: "http://schemas.datacontract.org/2004/07/WcfService1"
                345  // index: 345, string: "http://schemas.datacontract.org/2004/07/WcfService1"
        };
        ...
        static readonly global::DataContractMapEntry[] s_dataContractMap = new global::DataContractMapEntry[] {
                ...
                new global::DataContractMapEntry() {
                    UserCodeType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("Cwcf.ToDoService.CompositeType, Cwcf, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")),
                    TableIndex = 17, // 0x11
                }
        };
        [global::System.Runtime.CompilerServices.PreInitialized]
        ...
        static readonly global::ClassDataContractEntry[] s_classDataContracts = new global::ClassDataContractEntry[] {
                ...
                new global::ClassDataContractEntry() {
                    Common = new global::CommonContractEntry() {
                        HasRoot = true,
                        NameIndex = 331, // CompositeType
                        NamespaceIndex = 345, // http://schemas.datacontract.org/2004/07/WcfService1
                        StableNameIndex = 331, // CompositeType
                        StableNameNamespaceIndex = 345, // http://schemas.datacontract.org/2004/07/WcfService1
                        TopLevelElementNameIndex = 331, // CompositeType
                        TopLevelElementNamespaceIndex = 345, // http://schemas.datacontract.org/2004/07/WcfService1
                        OriginalUnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("Cwcf.ToDoService.CompositeType, Cwcf, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")),
                        UnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("Cwcf.ToDoService.CompositeType, Cwcf, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")),
                    },
                    HasDataContract = true,
                    XmlFormatReaderDelegate = global::SgIntrinsics.AddrOf<global::System.Runtime.Serialization.XmlFormatClassReaderDelegate>(global::Type2.ReadCompositeTypeFromXml),
                    XmlFormatWriterDelegate = global::SgIntrinsics.AddrOf<global::System.Runtime.Serialization.XmlFormatClassWriterDelegate>(global::Type3.WriteCompositeTypeToXml),
        ...
        static char[] s_stringPool = new char[] {
            ...
            '\0','C','o','m','p','o','s','i','t','e','T','y','p','e','\0','h','t','t','p',':','/','/','s','c','h','e','m','a','s','.',
            'd','a','t','a','c','o','n','t','r','a','c','t','.','o','r','g','/','2','0','0','4','/','0','7','/','W','c','f','S','e',
            'r','v','i','c','e','1','\0','H','e','l','p','L','i','n','k','\0','I','n','n','e','r','E','x','c','e','p','t','i','o','n',
            '\0','M','e','s','s','a','g','e','\0','S','t','a','c','k','T','r','a','c','e','\0','T','y','p','e','\0','B','o','o','l','V',
            'a','l','u','e','\0','S','t','r','i','n','g','V','a','l','u','e','\0'};
    }
}
